            ...
            <div class="profile_box" id="basicInfo">
                ...
                <div class="basicShow">
                   <span> <?php echo $data['username']?>|
                    <?php echo $data['sex']?> |                     大专 |                                       		3年工作经验
            		            			|<?php echo $data['home']?><br>
            			            				<?php echo $data['duty']?> · <?php echo $data['companyName']?> | 本科 · 北京大学<br>
            			            			<?php echo $data['tel']?> | <?php echo $data['email']?><br>
	                ...
	                <div class="expectShow">
	                	<?php echo $data['place']?>，<?php echo $data['job']?>，<?php echo $data['money']?>，<?php echo $data['positionName']?>
	                </div><!--end .expectShow-->
	            </div><!--end #expectJob-->
	                ...
	                <div class="experienceShow">
	                  <ul class="wlist clearfix">
	                  	                    	           				            				<li class="clear">
            					           					<span class="c9"><?php echo $data['jobstime']?></span>
	           					<div>
	           						<img width="56" height="56" alt="上海辉硕科技有限公司" src="style/images/logo_default.png">
	           						<h3><?php echo $data['duty']?> </h3>
	           						<h4><?php echo $data['projectName']?></h4>
	           					</div>
	           				</li>
	           					          				                  </ul>
	                ...
	                <div class="projectShow">
	                  <ul class="plist clearfix">
		            					...
		            					<div class="f16 mb10"><?php echo $data['projectName']?>
		            						<span class="c9">
		            									            								（2013.06-至今）
		            									            						</span>
		            					</div>
